...
- Agent 团队：`chief_of_staff`、`product`、`cto`、`designer`、`backend`、`frontend`、`qa`、`devops`、`content`、`growth`、`sales`、`finance`、`compliance`、`coding`。其中 `designer` 负责高级 UI 审美、Apple 风格参考、视觉层级、组件状态和设计 QA，帮助前端摆脱 AI 味。
